...
- `notebook.ipynb` → Jupyter notebook containing the full training pipeline and experiments  
- `predictions.json` → Final predictions generated by the trained model on the test dataset  
- `README.md` → Project documentation describing the approach and methodology  
- `weights_link.txt` → Link to download the trained model weights (`best.pt`)
